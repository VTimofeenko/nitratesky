...
EGO_SUM=(
	...
	"github.com/Azure/azure-service-bus-go v0.10.1 h1:w9foWsHoOt1n8R0O58Co/ddrazx5vfDY0g64/6UWyuo="
	...
	"github.com/GoogleCloudPlatform/cloudsql-proxy v0.0.0-20191009163259-e802c2cb94ae h1:sTOp2Ajiew5XIH92YSdwhYc+bgpUX5j5TKK/Ac8Saw8="
	...
	"github.com/aws/aws-sdk-go v1.38.23 h1:lSLWSu2itm9eH45iwiFCdcjFyU7Ec0oS0CNHr+/mVek="
	"github.com/aws/aws-sdk-go v1.38.23/go.mod h1:hcU610XS61/+aQV88ixoOzUoG7v3b31pl2zKMmprdro="
	...
	"github.com/evanw/esbuild v0.11.14 h1:y7LRq5lFjmucH8XbhmtJQbcHvBLE9GcX8bIKK0Hrq98="
	"github.com/evanw/esbuild v0.11.14/go.mod h1:y2AFBAGVelPqPodpdtxWWqe6n2jYf5FrsJbligmRmuw="
	"github.com/evanw/esbuild v0.11.16 h1:ysSn7DJ09i2r0/I4U+NlBEihlHXKGaKA0qy2ohXJ0Ss="
	"github.com/evanw/esbuild v0.11.16/go.mod h1:y2AFBAGVelPqPodpdtxWWqe6n2jYf5FrsJbligmRmuw="
...
"
# Needs go-1.16, otherwise error 'package io/fs is not in GOROOT (/usr/lib/go/src/io/fs)'
BDEPEND="
	>=dev-lang/go-1.16
"
...
IUSE="+bash-completion zsh-completion fish-completion doc +sass"

RESTRICT="test"

MY_COMPLETION_FILE="hugo_completion"
...
src_compile() {
	...
	local shelltype
	for shelltype in bash zsh fish; do
		if use "${shelltype}-completion"; then
			bin/hugo gen autocomplete --type=${shelltype} --completionfile "${MY_COMPLETION_FILE}".${shelltype} || die
		fi
	done
...
src_install() {
	...
	if use bash-completion ; then
		dobashcomp "${MY_COMPLETION_FILE}".bash || die
	fi
	# for zsh and fish there are no eclasses
	if use zsh-completion; then
		insinto /usr/share/zsh/site-functions
		newins "${MY_COMPLETION_FILE}".zsh _hugo
	fi

	if use fish-completion ; then
		insinto /usr/share/fish/functions/
		newins "${MY_COMPLETION_FILE}".fish hugo.fish
	fi
